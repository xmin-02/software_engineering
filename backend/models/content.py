...
class RealEstate(Base):
    ...
    dong: Mapped[str | None] = mapped_column(String(50))
    property_type: Mapped[str | None] = mapped_column(String(50))
    deal_type: Mapped[str | None] = mapped_column(String(50), index=True)
    price: Mapped[str | None] = mapped_column(String(100))
    deposit: Mapped[str | None] = mapped_column(String(100))
    monthly_rent: Mapped[str | None] = mapped_column(String(100))
    area_sqm: Mapped[float | None] = mapped_column(Float)
    floor: Mapped[str | None] = mapped_column(String(20))
    build_year: Mapped[str | None] = mapped_column(String(10))
